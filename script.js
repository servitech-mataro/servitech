...
function openProductModal(productId) {
    ...
    `;
        ...
        } else if (productId == 'component28') {
            productTitle.innerText = 'Be Quiet! Dark Power 13 850W 80 Plus Titanium Modular';
            productDescription.innerHTML = `
                La <strong>Be Quiet! Dark Power 13 850W</strong> és una font d'alimentació d'alt rendiment amb certificació <strong>80 Plus Titanium</strong>, dissenyada per a sistemes exigents que requereixen estabilitat i eficiència màxima. Amb el seu disseny modular, ofereix una millor gestió dels cables i una eficiència energètica excepcional.
            `;
            productCharacteristics.innerHTML = `
                <ul>
                    <li><strong>Potència:</strong> 850W
                        <ul>
                            <li>Potència suficient per alimentar components d'alt rendiment en sistemes de gaming o estacions de treball.</li>
                        </ul>
                    </li>
                    <li><strong>Certificació:</strong> 80 Plus Titanium
                        <ul>
                            <li>Eficiència energètica superior al 90%, que redueix el consum d'energia i les emissions de calor.</li>
                        </ul>
                    </li>
                    <li><strong>Factor de forma:</strong> ATX
                        <ul>
                    ...
                    <li><strong>Modularitat:</strong> Completament modular
                        <ul>
                            <li>Permet una gestió neta i eficient dels cables per a un millor flux d'aire dins la caixa.</li>
                        </ul>
                    </li>
                    <li><strong>Ventilador:</strong> 135mm SilentWings 3
                        <ul>
                            <li>Operació silenciosa amb un ventilador de 135mm que s'ajusta automàticament per mantenir una temperatura òptima.</li>
                        </ul>
                    </li>
                    <li><strong>Color:</strong> Negre
                        <ul>
                            <li>Disseny elegant en negre per a una estètica discreta i professional.</li>
                        </ul>
                    </li>
                    <li><strong>Proteccions:</strong> OVP, UVP, SCP, OPP, OTP
                        <ul>
                            <li>Protecció avançada contra sobretensions, sobrecàrregues i altres problemes elèctrics per garantir la seguretat del sistema.</li>
                        </ul>
                    </li>
                    <li><strong>Aplicacions recomanades:</strong>
                        <ul>
                            <li>PCs de gaming d'alta gamma.</li>
                            <li>Estacions de treball per a professionals de la creació de contingut.</li>
                            <li>Sistemes amb múltiples targetes gràfiques o components d'alt consum energètic.</li>
                        </ul>
                    </li>
                </ul>
            `;
